...
private:
	struct StackNode {              // linked list node
		Coordinate data;                     // data at this node
...
void main()
{
	...
	char sourceFileEmpty[10] = "empty.txt";
	char sourceFile1[10] = "1.txt";
	char sourceFile2[10] = "2.txt";
	int select;
	char cont;
	...
	do {
		...
		do {
			cout << "Please pick a labyrinth (1/2/3):" << endl;
